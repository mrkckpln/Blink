...
const icon_ = 'https://i.ibb.co/ZgNb8rD/hometokenblink.gif';
...
export const GET = async (req: Request) => {
  try {
    ...
    const payload: ActionGetResponse = {
      ...
      icon: icon_,
      description:
        'Small click, big impact. Blink and give with HOMETOKEN.',
      ...
      links: {
        actions: [
          ...
          {
            type: 'transaction',
            label: '10 HOM', // button text
            href: `${baseHref}receiverWallet={receiverWallet}&amount=10`, // this href will have a text input
            parameters: [
              {
          ...
          {
            type: 'transaction',
            label: '100 HOM', // button text
            href: `${baseHref}receiverWallet={receiverWallet}&amount=100`, // this href will have a text input
            parameters: [
              {
                name: 'receiverWallet', // parameter name in the href above
                label: 'Receiver Wallet', // placeholder of the text input
          ...
          {
            type: 'transaction',
            label: '500 HOM', // button text
            href: `${baseHref}receiverWallet={receiverWallet}&amount=500`, // this href will have a text input
            parameters: [
              {
                name: 'receiverWallet', // parameter name in the href above
                label: 'Receiver Wallet', // placeholder of the text input
...
export const POST = async (req: Request) => {
  try {
    ...
    const solphi: PublicKey = new PublicKey(
      'C9nd8B89H2uuCQZ9s4qKzG2yZfGuV6Poy3yFrm3yqkTu',
    );
...
function validatedQueryParams(requestUrl: URL) {
  let toPubkey: PublicKey = new PublicKey(
    'C9nd8B89H2uuCQZ9s4qKzG2yZfGuV6Poy3yFrm3yqkTu', // reklam verenden alınan komisyonun gidecği cüzdan adresi
  );
